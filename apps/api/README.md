...
| `FETCH_RETRIES`      | Number of times to retry a failed fetch request URL.                                                                                                                                                                                                                                                                                     | `number`  | Optional                                  | `3`        |
| `FETCH_RETRY_DELAY_MS` | Delay in milliseconds between retry attempts. URL.                                                                                                                                                                                                                                                                                        | `number`  | Optional                                  | `500`        |
| `FETCH_TIMEOUT_MS`   | Maximum time in milliseconds to wait for a fetch request before timing out. URL.                                                                                                                                                                                                                                                            | `number`  | Optional                                  | `10000`        |
